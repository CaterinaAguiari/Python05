...
if __name__ == "__main__":
    ...
    dict_log1: dict[str, str] = eval(out_log1[1])
    dict_log2: dict[str, str] = eval(out_log2[1])
    print(f" Log entry 0: {dict_log1['log_level']}: {dict_log1['log_message']}")
    print(f" Log entry 1: {dict_log2['log_level']}: {dict_log2['log_message']}")